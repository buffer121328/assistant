...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--langfuse",
        action="store_true",
        help="Also publish sanitized cases to Langfuse datasets/experiments when configured.",
    )
    parser.add_argument(
        "--langfuse-name",
        default="assistant.core_commands",
        help="Langfuse dataset/experiment name used with --langfuse.",
    )
...
def main() -> int:
    ...
    from observability import run_core_command_langfuse_experiment
        ...
        if settings.langfuse_public_key and settings.langfuse_secret_key:
            try:
                ...
                run_core_command_langfuse_experiment(
                    ...
                    metadata={
                        "source": "scripts/eval/run_evaluation.py",
