...
from .credential_cipher import CredentialCipher, CredentialError
from .email_calendar_providers import ProviderError
...
class BrowserSession:
    ...
    connection_id: str  # connection_id 对应的数据字段。
    allowed_domains: tuple[str, ...]  # allowed_domains 对应的数据字段。
    storage_state: dict[str, Any]  # storage_state 对应的数据字段。
