...
class SmtpConfig:
    ...
    host: str  # host 对应的数据字段。
    port: int  # port 对应的数据字段。
    username: str  # username 对应的数据字段。
    password: str  # password 对应的数据字段。
    from_address: str  # from_address 对应的数据字段。
    security: str = "starttls"  # security 对应的数据字段。
    timeout: float = 15.0  # timeout 对应的数据字段。
