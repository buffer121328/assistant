...
class RunBudget:
    ...
    max_steps: int = 12  # max_steps 对应的数据字段。
    max_tool_calls: int = 15  # max_tool_calls 对应的数据字段。
    max_input_tokens: int = 32_000  # max_input_tokens 对应的数据字段。
    max_output_tokens: int = 8_000  # max_output_tokens 对应的数据字段。
    deadline_at: datetime | None = None  # deadline_at 对应的数据字段。
    steps_used: int = 0  # steps_used 对应的数据字段。
    tool_calls_used: int = 0  # tool_calls_used 对应的数据字段。
    input_tokens_used: int = 0  # input_tokens_used 对应的数据字段。
    output_tokens_used: int = 0  # output_tokens_used 对应的数据字段。
    stop_reason: str | None = None  # stop_reason 对应的数据字段。
