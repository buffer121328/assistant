...
from application.task_execution.lifecycle import TaskServiceError, UserNotFoundError
...
class ShadowComparison:
    ...
    active_version: str  # active_version 对应的数据字段。
    shadow_version: str  # shadow_version 对应的数据字段。
    active_memory_ids: tuple[str, ...]  # active_memory_ids 对应的数据字段。
    shadow_memory_ids: tuple[str, ...]  # shadow_memory_ids 对应的数据字段。
    changed_positions: int  # changed_positions 对应的数据字段。
