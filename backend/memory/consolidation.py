...
class ReconciliationReport:
    ...
    missing_memory_ids: tuple[str, ...] = ()  # missing_memory_ids 对应的数据字段。
    orphan_index_ids: tuple[str, ...] = ()  # orphan_index_ids 对应的数据字段。
    deleted_orphan_count: int = 0  # deleted_orphan_count 对应的数据字段。
