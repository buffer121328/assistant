...
class QueryTypeProfile:
    ...
    query_type: QueryType  # query_type 对应的数据字段。
    semantic: float  # semantic 对应的数据字段。
    keyword: float  # keyword 对应的数据字段。
    recency: float  # recency 对应的数据字段。
    importance: float  # importance 对应的数据字段。
    feedback: float  # feedback 对应的数据字段。
