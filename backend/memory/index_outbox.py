...
class MemoryIndexOutboxResult:
    ...
    recovered_count: int = 0  # recovered_count 对应的数据字段。
    processed_count: int = 0  # processed_count 对应的数据字段。
    succeeded_count: int = 0  # succeeded_count 对应的数据字段。
    retry_count: int = 0  # retry_count 对应的数据字段。
    failed_count: int = 0  # failed_count 对应的数据字段。
...
class _OperationResult:
    ...
    succeeded: bool  # succeeded 对应的数据字段。
    error_code: str | None = None  # error_code 对应的数据字段。
    retryable: bool = True  # retryable 对应的数据字段。
