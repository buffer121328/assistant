...
class SourceEvent:
    ...
    trust: SourceTrust  # trust 对应的数据字段。
...
class CandidateDraft:
    ...
    atomic_content: str  # atomic_content 对应的数据字段。
    scope_kind: str  # scope_kind 对应的数据字段。
    scope_id: str | None  # scope_id 对应的数据字段。
    confidence: float  # confidence 对应的数据字段。
    sensitivity: str  # sensitivity 对应的数据字段。
    source_spans: tuple[str, ...] = ()  # source_spans 对应的数据字段。
    candidate_links: tuple[str, ...] = ()  # candidate_links 对应的数据字段。
    reason_code: str = "model_extracted"  # reason_code 对应的数据字段。
