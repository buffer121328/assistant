...
def _builtin_metadata() -> tuple[CapabilityMetadata, ...]:
    ...
    definitions: tuple[
        ...
        (
            ...
            CapabilityKind.CODE,
            "任务状态",
            "查看当前用户的任务执行状态，不经过模型执行。",
            "L1",
            False,
            ("task.check_status", "task.get_result"),
        ),
        (
            "profile.plan",
            CapabilityKind.AGENT_PROFILE,
            "任务规划",
            "通过当前 Agent Harness 创建结构化任务计划。",
            "L1",
            False,
        ...
        (
            ...
            "L2",
            False,
            (*_WORKSPACE_READ_TOOLS, "knowledge.search"),
        ),
        (
            "profile.daily",
            CapabilityKind.AGENT_PROFILE,
        ...
        (
            ...
            "AI 改进运营",
            "收集明确提交的问题，形成解决建议，并设计待审批的能力与 MCP 集成方案。",
            "L1",
            False,
            (),
        ),
