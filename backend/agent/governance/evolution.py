...
class BehaviorMetrics:
    ...
    task_count: int  # task_count 对应的数据字段。
    successful_task_count: int  # successful_task_count 对应的数据字段。
    failed_task_count: int  # failed_task_count 对应的数据字段。
    waiting_approval_task_count: int  # waiting_approval_task_count 对应的数据字段。
    tool_log_count: int  # tool_log_count 对应的数据字段。
    failed_tool_log_count: int  # failed_tool_log_count 对应的数据字段。
    task_failure_rate: float  # task_failure_rate 对应的数据字段。
    approval_wait_rate: float  # approval_wait_rate 对应的数据字段。
...
class EvolutionSuggestion:
    ...
    target: str  # target 对应的数据字段。
    reason: str  # reason 对应的数据字段。
    proposed_direction: str  # proposed_direction 对应的数据字段。
    metrics: BehaviorMetrics  # metrics 对应的数据字段。
