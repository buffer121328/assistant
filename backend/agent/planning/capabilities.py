...
from tools.core.catalog import ToolCatalogSnapshot, ToolSelectionResult
...
class ToolCapability:
    ...
    approval_required: bool = False  # approval_required 对应的数据字段。
...
class CapabilitySnapshot:
    ...
    summaries: tuple[str, ...]  # summaries 对应的数据字段。
    revision: int = 0  # revision 对应的数据字段。
    tool_versions: tuple[tuple[str, str], ...] = ()  # tool_versions 对应的数据字段。
    selection_reasons: tuple[tuple[str, str], ...] = ()  # selection_reasons 对应的数据字段。
