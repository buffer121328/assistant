...
class PromptValidationError(ValueError):
    """Raised when a prompt module or managed prompt change is invalid."""

    pass


class PromptStore:
    """Load, build, validate, propose, apply, and rollback prompt modules."""
    ...
    def load_module(self, name: str) -> PromptModule:
        """Load one prompt module, preferring managed over defaults."""
    ...
    def inspect(self) -> dict[str, object]:
        """Return metadata for loaded prompt modules."""
    ...
    def list_versions(self) -> dict[str, object]:
        """List managed prompt version marker files."""
