...
class CitationValidationResult:
    ...
    valid: bool  # valid 对应的数据字段。
    cited_source_ids: tuple[str, ...]  # cited_source_ids 对应的数据字段。
    unknown_source_ids: tuple[str, ...]  # unknown_source_ids 对应的数据字段。
    missing_required_citation: bool  # missing_required_citation 对应的数据字段。
