...
from infrastructure.security.auth import ELECTRON_DEV_ORIGINS, LocalApiAuthMiddleware
...
def create_app(
    ...
    *,
    ...
    app.add_middleware(
        CORSMiddleware,
        allow_origins=list(ELECTRON_DEV_ORIGINS),
        allow_credentials=False,
        allow_methods=["GET", "POST", "PUT", "DELETE", "OPTIONS"],
        allow_headers=["Authorization", "Content-Type", "X-Assistant-Session"],
    )
