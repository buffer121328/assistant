...
class ModelLogCreate:
    ...
    request_text: str | None  # request_text 对应的数据字段。
    response_text: str | None  # response_text 对应的数据字段。
    error_message: str | None  # error_message 对应的数据字段。
    agent_run_id: str | None = None  # agent_run_id 对应的数据字段。
