...
class ProcessedMessageCreate:
    ...
    adapter: str | None = None  # adapter 对应的数据字段。
    sender_id: str | None = None  # sender_id 对应的数据字段。
    conversation_type: str | None = None  # conversation_type 对应的数据字段。
    message_text: str | None = None  # message_text 对应的数据字段。
    intent_outcome: str | None = None  # intent_outcome 对应的数据字段。
    chat_id: str | None = None  # chat_id 对应的数据字段。
    response_target: str | None = None  # response_target 对应的数据字段。
    task_id: str | None = None  # task_id 对应的数据字段。
    delivery_status: str | None = None  # delivery_status 对应的数据字段。
    delivery_error_summary: str | None = None  # delivery_error_summary 对应的数据字段。
    delivery_result_json: str | None = None  # delivery_result_json 对应的数据字段。
