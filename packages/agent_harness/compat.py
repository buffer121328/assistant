...
from packages.memory import SemanticMemory

from .ports import ConversationContextPack
...
async def record_execution_trace(
    ...
    *,
    ...
    from assistant_api.models import ToolLog
...
async def execute_status_task(session: AsyncSession, *, task_id: str) -> Any:
    from assistant_api.services import StatusService
...
async def load_user(
    ...
    *,
    ...
    from assistant_api.models import User
...
async def load_conversation_context(
    ...
    *,
    ...
    from packages.memory.working_set import ConversationMessageRef, build_context_pack
