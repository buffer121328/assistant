...
if TYPE_CHECKING:
    from packages.agent_harness.skill_store import ManagedSkillStore
    from packages.tools import ToolCatalogSnapshot
...
def _load_builtin_skill(skills_root: Path, name: str) -> object:
    from packages.agent_harness.skills import SkillsLoader
